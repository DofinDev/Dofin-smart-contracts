...
contract ChargedBunkersFactory {
    ...
    function setConfigBunker (uint256 _id, address[8] memory _config, address[] memory _rtokens, address _dofin, uint256[2] memory _deposit_limit, bool _wrap) external returns(bool) {
        require(msg.sender == _owner, "Only Owner can call this function");
